...
package morn.core.components {
	...
	public class Label extends Component {
		...
		protected function changeText():void {
			...
			_isHtml ? _textField.htmlText = UIManager.lang.getLang(_text) : _textField.text = UIManager.lang.getLang(_text);
		}
		...
		public function set skin(value:String):void {
			if (_skin != value) {
				_skin = value;
				_bitmap.bitmapData = UIManager.asset.getBitmapData(_skin);
